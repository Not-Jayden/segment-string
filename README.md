...
<p align="center">A lightweight wrapper around Intl.Segmenter for grapheme-aware string operations</p>
...
```shell
npm i segment-string
```

```ts
import { GraphemeString } from "segment-string";

const str = new GraphemeString("Hello, world! 💖");
```
